...
export default function AssociatedSegment(props) {
          ...
          <div className="container w-full">
            ...
            <div className="flex flex-col items-center justify-center m-4">
              <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="mb-8 sm:break-inside-avoid">
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <p className="mt-4 text-gray-700">
                          ...
                          dolore eos quasi a ex aliquam molestiae. Tenetur hic
                          delectus maxime.
                        </p>
                      </blockquote>
                    </div>
                    ...
                    <div className="mb-8 sm:break-inside-avoid">
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <p className="mt-4 text-gray-700">
                          ...
                          Culpa commodi quae atque perspiciatis? Provident,
                          magni beatae saepe porro aspernatur facere neque sunt
                          possimus assumenda perspiciatis aperiam quisquam animi
                          libero voluptatem fuga. Repudiandae, facere? Nemo
                ...
                <div className="flex mt-[2rem] w-1/2 h-3 border-t-2"></div>
              <div className="flex justify-center">
                <p className="text-center font-patrickhand text-lg">
                  Whether you have an job opportunity for me, require
                  mentorship, or just want to say hello... I’ll make the coffee.
                </p>
              </div>
              <div className="flex justify-center">
                <Link
